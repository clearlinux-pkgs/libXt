...
Source0  : https://www.x.org/releases/individual/lib/libXt-1.3.0.tar.xz
Source1  : https://www.x.org/releases/individual/lib/libXt-1.3.0.tar.xz.sig
...
%prep
%setup -q -n libXt-1.3.0
cd %{_builddir}/libXt-1.3.0
pushd ..
cp -a libXt-1.3.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682963314
