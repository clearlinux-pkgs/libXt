...
Source0  : https://www.x.org/releases/individual/lib/libXt-1.3.1.tar.xz
Source1  : https://www.x.org/releases/individual/lib/libXt-1.3.1.tar.xz.sig
...
%setup -q -n libXt-1.3.1
cd %{_builddir}/libXt-1.3.1
pushd ..
cp -a libXt-1.3.1 build32
popd
pushd ..
cp -a libXt-1.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732031110
...
cp %{_builddir}/libXt-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libXt/029bfe91e53bfa28711f711c70e5a29b2d691155 || :
export GOAMD64=v2
pushd ../build32/
%make_install32
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/libXt/029bfe91e53bfa28711f711c70e5a29b2d691155
